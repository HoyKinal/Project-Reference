...
{
    //DbContext class is a key part of the ORM (Object-Relational Mapping) system. 
    public class ShopOnlineDbContext:DbContext
    {
        //This constructor is necessary to configure how the DbContext connects to the database
        ...
        // Used to configure the model of the database.
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            base.OnModelCreating(modelBuilder);
            //Configure relationship table
            ...
            // Cart and CartItem: 1:M
            modelBuilder.Entity<Cart>()
                .HasMany(c => c.CartItems)
                .WithOne(ci => ci.Cart)
                .HasForeignKey(ci => ci.CartId);

            // Product and CartItem: 1:M
            modelBuilder.Entity<Product>()
                .HasMany(p => p.CartItems)
                .WithOne(ci => ci.Product)
                .HasForeignKey(ci => ci.ProductId);

            // ProductCategory and Product: 1:M
